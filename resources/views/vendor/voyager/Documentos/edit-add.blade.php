                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                <div id='{{ $row->getTranslatedAttribute('field') }}' class="form-group @if($row->type == 'hidden') hidden @endif col-md-{{ $display_options->width ?? 12 }} {{ $errors->has($row->field) ? 'has-error' : '' }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                    {{ $row->slugify }}
...
// $().trigger*()
// Función para mostrar u ocultar campos dependiendo del valor de "idtipo"
function mostrarOcultarCampos() {
    var idtipoValue = $(this).val();

    // Ocultar todos los campos
    $('.form-group').not('#documento_belongsto_tipo_relationship').hide();
...
function mostrarCamposSeleccionados() {
    var camposSeleccionados = $('.form-group:visible').map(function() {
        return this.id;
    }).get();
